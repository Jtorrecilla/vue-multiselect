...
exports.default = {
  ...
  methods: {
    ...
    removeElement: function removeElement(option) {
      ...
      if ((typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object') {
        debugger;
        newIndex = index === -1 || index === 0 ? this.internalValue.indexOf(this.internalValue.find(function (el) {
          return el.__internalId === option.__internalId;
        })) : index;
        console.log('New Index' + newIndex);
        console.log('Index' + index);
        console.log(this.internalValue.indexOf(this.internalValue.find(function (el) {
          return el.__internalId === option.__internalId;
        })));
      } else {
